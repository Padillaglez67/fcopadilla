...
description: Filosofía de Emil Kowalski sobre pulido de interfaces, diseño de componentes, decisiones de animación y los detalles invisibles que hacen que un software se sienta bien. INVOCACIÓN MANUAL ÚNICAMENTE: no se activa sola; se usa solo cuando se pide por su nombre.
